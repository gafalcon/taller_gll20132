...
\begin{itemize}
\item Vaya al directorio C : \backslash y descomprimir la distribución ML Moscú
...
Esto crea un directorio C: \backslash mOsml con subdirectorios
...
\item Añadir C: \backslash mOsml \backslash bin a la variable PATH, y establecer el entorno
     variable ` mosmllib ' a C: \backslash mOsml \backslash lib .

\begin{itemize}
\item En el caso de Windows 95/98/ME Si su archivo AUTOEXEC.BAT contención algo como:

\space \space SET PATH = c: \backslash dos ; ... C: \backslash mOsml \backslash bin , establecer MOSMLLIB = C: \backslash mOsml \backslash lib
